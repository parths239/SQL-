...
INSERT INTO products (name, price, coffee_origin)
VALUES('Macchiato', 3.50, 'Brazil'), ('Cappuccino', 3.50, 'Costa Rica');
...
WHERE coffee_origin IN ('Columbia', 'India')
ORDER BY name ASC;

SELECT * FROM orders;

SELECT * FROM orders
WHERE order_time BETWEEN '2023-02-01 00:00:00'AND '2023-02-28 23:59:59'
...
SELECT DISTINCT last_name AS `Last Name` FROM customers
ORDER BY last_name;
...
SELECT * FROM orders
WHERE product_id = 3 
AND order_time BETWEEN  '2023-02-01 00:00:00'AND '2023-02-28 23:59:59'
ORDER BY order_time
LIMIT 4;
...
WHERE p.name = 'Filter'
AND o.order_time BETWEEN '2023-01-01 00:00:00' AND '2023-03-31 23:59:59';

SELECT p.name, p.price, o.order_time FROM  products p
JOIN orders o ON p.id = o.product_id
JOIN customers c ON c.id = o.customer_id
WHERE c. gender = 'F'
AND o.order_time BETWEEN '2023-01-01 00:00:00' AND '2023-01-31 23:59:59';
